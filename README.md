...
* **Exploração (Backtracking):** O mapa é **não-linear**. O jogador encontrará portões trancados (soft-locks) e precisará explorar outras áreas para achar **itens-chave** (como uma "Chave do Pátio" ou um "Pé de Cabra") e retornar para desbloquear o caminho.
...
A trilha sonora deve evoluir conforme o progresso e a tensão do jogador:

### Faixas e Temas:
* **Masmorras:** Sons ambientes de tensão (correntes, goteiras, vento uivando) e música minimalista grave.
    * *Referência:* Temas de "Dungeon" de **Zelda: A Link to the Past** ou **Castlevania**.
* **Batalha/Chefe:** Música mais rápida e rítmica, com elementos percussivos para gerar adrenalina.
* **SFX (Efeitos Sonoros):** Sons "crocantes" e curtos estilo retrô para pulos, ataques e coleta de itens.
...
![Screenshot da Cela da Masmorra](img1.png)
...
![Screenshot do Pátio Principal da Fortaleza](img2.png)